...
public class zeyadpatient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zeyadpatient);
                ...
                fAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(zeyadpatient.this, "User Created. ", Toast.LENGTH_SHORT).show();
                            openActivity();

                        }
                        else {
                            Toast.makeText(zeyadpatient.this, "Error"+task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void openActivity() {
        Intent intent= new Intent(this,MedicalReport.class);
